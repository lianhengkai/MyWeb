...
(1, 'slackck', 'e10adc3949ba59abbe56e057f20f883e', '876902658@qq.com', '沈利', '15959715286', 126, '127.0.0.1', 112222233, '72ffa9e58f3ed5ae518747e9afa26625', 1),
(2, 'xiaoli', 'e10adc3949ba59abbe56e057f20f883e', '274476526@qq.com', '李', '15959715286', 2, '127.0.0.1', 1446683501, '', 1),
(5, '123', '4297f44b13955235245b2497399d7a93', '123123@qq.com', '123', '18039834166', 1, '127.0.0.1', 1448612549, '0', 1);
...
(2, '管理员', 1, '1,2,6,10,19,3,4,5,15,16,17,18,7,8,11,12,9,13,14,27,', 1212451252);
...
(30, 'Member/member_score', '积分管理', 1, 0, '', '', 27, 20, 1447232133),
...
(44, 'Plug/plug_ad_list', '广告管理', 1, 1, '', '', 28, 50, 1450314265),
...
(40, 'Sys/excel_import', 'Excel导入/导出', 1, 1, '', '', 1, 50, 1448613588),
(41, 'Sys/excel_import', 'Excel导入', 1, 1, '', '', 40, 50, 1448613614),
(42, 'Sys/excel_export', 'Excel导出', 1, 1, '', '', 40, 50, 1448613651),
(43, 'Sys/source', '来源管理', 1, 1, '', '', 2, 50, 1448940532),
(45, 'Plug/plug_ad_list', '广告设置', 1, 1, '', '', 44, 50, 1450314297),
(46, 'Plug/plug_adtype_list', '广告位设置', 1, 1, '', '', 44, 50, 1450314324),
(47, 'Plug/plug_ad_dep', '投放单位设置', 1, 0, '', '', 44, 50, 1450320563),
(48, 'Plug/plug_sug_list', '留言插件', 1, 1, '', '', 28, 50, 1451267354),
(49, 'Plug/plug_sug_list', '留言管理', 1, 1, '', '', 48, 50, 1451267369);
...
CREATE TABLE IF NOT EXISTS `mr_plug_ad` (
...
INSERT INTO `mr_plug_ad` (`plug_ad_id`, `plug_ad_name`, `plug_ad_adtypeid`, `plug_ad_pic`, `plug_ad_url`, `plug_ad_addtime`, `plug_ad_order`, `plug_ad_open`, `plug_ad_depid`, `plug_ad_butt`) VALUES
(1, '轮播图片一', 1, '/uploads/Ad/2015-12-28/5680abb945ec1.jpg', '', 1451273145, 50, 1, 0, 0);
...
CREATE TABLE IF NOT EXISTS `mr_plug_adtype` (
...
--
-- 转存表中的数据 `mr_plug_adtype`
--

INSERT INTO `mr_plug_adtype` (`plug_adtype_id`, `plug_adtype_name`, `plug_adtype_order`) VALUES
(1, '首页图片轮播', 50);
...
CREATE TABLE IF NOT EXISTS `mr_plug_sug` (
...
CREATE TABLE IF NOT EXISTS `mr_region` (
...
INSERT INTO `mr_region` (`id`, `pid`, `name`, `type`) VALUES
(1, 0, '中国', 0),
(2, 1, '北京', 1),
(3, 1, '安徽', 1),
(4, 1, '福建', 1),
...
(1, '厦门市净悦庆典有限公司', 'http://www.xmjyqd.com', '厦门婚庆_厦门庆典_厦门市净悦庆典有限公司', '厦门婚庆,厦门庆典,厦门市净悦庆典有限公司', '厦门婚庆_厦门庆典_厦门市净悦庆典有限公司', 1, '876902658@qq.com', 'maggie198586', 'smtp.qq.com', '876902658', '网站管理员', '护士之家', 'lyzj99', 'dkfje11235_b', 2, 'wx3e5b1606b21cc3bb', '9225a5a6d2da8f0571cdb41353bebcd7', 'weixin');
